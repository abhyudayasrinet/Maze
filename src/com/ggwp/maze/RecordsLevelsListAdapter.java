...
public class RecordsLevelsListAdapter extends ArrayAdapter<String>{
	...
	LevelsDB DB;
	public RecordsLevelsListAdapter(Context context, int resource, List<String> objects,List<String> timeTaken,List<String> moves) {
